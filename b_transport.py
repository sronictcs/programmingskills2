...
'''2-3. Your Own List: Think of your favorite mode of
transportation,
...
'''2-4. Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite?
Make a list that includes at least three people you’d like to invite to dinner.
Then use your list to print a message to each person, inviting them to dinner.'''
#put your code here


#to change an item in a list replace the element with an =
#e.g. cars[2] = "hyundai"
cars = ["bmw", "audi", "toyota", "subaru"]
print(cars)
cars[2] = "hyundai"
...
#to insert to a position in a list use .insert(position, "item")
cars.insert(2, "volvo")
print(cars)

'''2-5. Changing Guest List: You just heard that one of your guests can’t make the dinner,
...
'''
2-6. More Guests: You just found a bigger
